...
const en = {
  ...
  'sidebar.tabProjects': 'Projects',
  'sidebar.projectsTitle': 'Projects',
  'sidebar.projectsEmpty': 'Project management coming soon.',
...
const fr: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'Sessions',
  'sidebar.tabProjects': 'Projets',
  'sidebar.projectsTitle': 'Projets',
  'sidebar.projectsEmpty': 'Gestion de projets à venir.',
...
const es: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'Sesiones',
  'sidebar.tabProjects': 'Proyectos',
  'sidebar.projectsTitle': 'Proyectos',
  'sidebar.projectsEmpty': 'Gestión de proyectos próximamente.',
...
const de: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'Sitzungen',
  'sidebar.tabProjects': 'Projekte',
  'sidebar.projectsTitle': 'Projekte',
  'sidebar.projectsEmpty': 'Projektverwaltung kommt bald.',
...
const ja: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'セッション',
  'sidebar.tabProjects': 'プロジェクト',
  'sidebar.projectsTitle': 'プロジェクト',
  'sidebar.projectsEmpty': 'プロジェクト管理機能は近日公開予定です。',
...
const pt: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'Sessões',
  'sidebar.tabProjects': 'Projetos',
  'sidebar.projectsTitle': 'Projetos',
  'sidebar.projectsEmpty': 'Gerenciamento de projetos em breve.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabProjects': '项目',
  'sidebar.projectsTitle': '项目',
  'sidebar.projectsEmpty': '项目管理功能即将推出。',
  'split.close': '关闭分屏',
  'app.mainChat': '主聊天',
  'app.splitPane': '分屏面板',
...
const it: Record<keyof typeof en, string> = {
  ...
  'sidebar.tabSessions': 'Sessioni',
  'sidebar.tabProjects': 'Progetti',
  'sidebar.projectsTitle': 'Progetti',
  'sidebar.projectsEmpty': 'Gestione progetti in arrivo.',
